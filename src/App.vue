...
<template>
  <div class="">
      <header>
        <nav class="navbar navbar-expand-lg bg-light-blue" style="">
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                  <RouterLink class="nav-link" :to="{name:'register'}">About</RouterLink>
                </li>
                <li class="nav-item" v-if="auth.check">
                  <RouterLink class="nav-link" :to="{name:'vehicles.index'}">About</RouterLink>
                </li>
                <li class="nav-item" v-else>
                  <RouterLink class="nav-link" :to="{name:'home'}">About</RouterLink>
                </li>
              </ul>
