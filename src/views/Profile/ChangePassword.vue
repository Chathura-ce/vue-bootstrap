        ...
        <div class="card shadow-lg">
          ...
          <div class="card-body">
            ...
            <form @submit.prevent="store.updatePassword()" novalidate>
              <div class="mb-3">
                <label for="email" class="form-label">Current Password<span class="text-danger">*</span></label>
                <input v-model="store.form.current_password" type="password" class="form-control"
                       :disabled="store.loading"
                       :class="validationClass('current_password')" id="current_password" name="current_password"
              ...
              <div class="mb-3">
                ...
                <input v-model="store.form.password_confirmation" type="password" class="form-control"
                       :disabled="store.loading"
                       :class="validationClass('password_confirmation')" id="password_confirmation" name="password_confirmation"
              ...
              <div class="d-grid gap-2">
                <button class="btn btn-outline-primary" type="submit" :disabled="store.loading">
                  <IconSpiner v-show="store.loading" />Update Password</button>
              </div>
            </form>
          </div>
        </div>
